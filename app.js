...
var budgetController = (function() {
  ...
  return {
    addItem: function (type, des, val) {
      ...
      // Pushing items to the data structure
...
var controller = (function(budgetCtlr, UICtlr) {
  ...
  var updatePercentages = function() {
    ...
    // 2. Read the poercentages from the buidget controller
    var percentage = budgetCtlr.getPercentages();
    // 3. Update tyhre percentage in the UI
    UICtlr.displayPercentages(percentage);
  ...
  var ctrlDeleteItem = function(event) {
    ...
    if (itemID) {
      ...
      // 1. Delete the item from ther data structure
